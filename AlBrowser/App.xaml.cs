...
namespace Al_Browser
{
    ...
    sealed partial class App : Application
    {
        ...
        protected override void OnLaunched(LaunchActivatedEventArgs e)
        {
            ...
            SQLiteConnection objConn = new SQLiteConnection("AlBrowser.db");
            objConn.Prepare(@"CREATE TABLE IF NOT EXISTS favorites (id integer primary key autoincrement, name varchar(255), url text);").Step();
            objConn.Prepare(@"CREATE TABLE IF NOT EXISTS history (id integer primary key autoincrement, name varchar(255), url text, times int);").Step();
